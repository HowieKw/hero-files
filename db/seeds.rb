...
# -------- SUPERHERO ---------
scarlet_witch = Superhero.create(alias: "Scarlet Witch", name: "Wanda Maximoff", creator: "Marvel Comics", universe: "Prime Earth-616", powers: "Chaos Magic, Witchcraft, Reality Warping, Nexus Being, Occult & Magical Knowledge", like_count: 0)
doctor_strange = Superhero.create(alias: "The Sorcerer Supreme", name: "Stephen Strange", creator: "Marvel Comics", universe: "Prime Earth-616", powers: "Mystic Arts, Longevity, The Words, Divine Source/Conduit", like_count: 0)
blade = Superhero.create(alias: "Blade", name: "Eric Brooks", creator: "Marvel Comics", universe: "Prime Earth-616", powers: "Dhampir Physiology, Master Martial Artist, Weapon Proficiency, Expert Marksman, Multilingual", like_count: 0)
starfire = Superhero.create(alias: "Starfire", name: "Koriand'r", creator: "DC Comics", universe: "Prime Earth", powers: "Tamaranean Physiology, UV Absorption, Flight, Starbolts, Linguisitc Assimilation, Hand-to-Hand Combat", like_count: 0)
raven = Superhero.create(alias: "Raven", name: "Rachel Roth", creator: "DC Comics", universe: "Prime Earth", powers: "Astral Projection, Soul-Self, Telekinesis, Empathy, Telepathy, Magic")
omniman = Superhero.create(alias: "Omni-Man", name: "Nolan Grayson", creator: "Image Comics", universe: "Image Universe", powers: "Superhuman Strength, Speed, Stamina, and Endurance; Flight, Interstellar Travel, Longevity, Healing Factor", like_count: 0)
atom_eve = Superhero.create(alias: "Atom Eve", name: "Samantha Eve Wilkins", creator: "Image Comics", universe: "Image Universe", powers: "Subatomic Manipulation, Flight, Immortality", like_count: 0)
all_might = Superhero.create(alias: "All Might", name: "Toshinori Yagi", creator: "Shueisha", universe: "My Hero Academia", powers: "Indomitable Spirit, One For All; Superhuman Strength, Speed, Stamina, and Endurance", like_count: 0)

# -------- POWERSTATS ---------
stat1 = Powerstat.create(intelligence: 8, strength: 2, speed: 8, durability: 7, power: 10, combat: 4, superhero_id: scarlet_witch.id)
stat2 = Powerstat.create(intelligence: 9, strength: 3, speed: 10, durability: 9, power: 1, combat: 6, superhero_id: doctor_strange.id)
stat3 = Powerstat.create(intelligence: 6, strength: 3, speed: 3, durability: 3, power: 3.5, combat: 8.5, superhero_id: blade.id)
stat4 = Powerstat.create(intelligence: 6.5, strength: 9.5, speed: 8, durability: 5.5, power: 10, combat: 6.5, superhero_id: starfire.id)
stat5 = Powerstat.create(intelligence: 8, strength: 3, speed: 8, durability: 7, power: 10, combat: 6, superhero_id: raven.id)
stat6 = Powerstat.create(intelligence: 8, strength: 10, speed: 10, durability: 7, power: 8, combat: 9, superhero_id: omniman.id)
stat7 = Powerstat.create(intelligence: 7.5, strength: 1, speed: 2.5, durability: 5, power: 8.5, combat: 3, superhero_id: atom_eve.id)
stat8 = Powerstat.create(intelligence: 7.5, strength: 1, speed: 5, durability: 9, power: 9, combat: 9, superhero_id: all_might.id)

# -------- APPEARANCE ---------
app1 = Appearance.create(gender: "Female", species: "Human, genetically altered", height: "170.2 cm • 5\'7\"", weight: "59.9 kg • 132.06 lbs", eye_color: "Blue", hair_color: "Auburn", img_url: "https://res.cloudinary.com/djzhu5kfj/image/upload/v1633545112/Flatiron%20-%20Phase%204%20Project/Scarlet_Witch_swykpi.jpg", ani: "./images/Scarlet-Witch.gif", superhero_id: scarlet_witch.id)
app2 = Appearance.create(gender: "Male", species: "Human", height: "188 cm • 6\'2\"", weight: "81.6 kg • 179.9 lbs", eye_color: "Grey", hair_color: "Black w/white streaks", img_url: "https://res.cloudinary.com/djzhu5kfj/image/upload/v1633545119/Flatiron%20-%20Phase%204%20Project/Doctor_Strange_sxqu22.jpg", ani: "./images/Doctor-Strange.gif", superhero_id: doctor_strange.id)
app3 = Appearance.create(gender: "Male", species: "Dhampir", height: "188 cm • 6\'2\"", weight: "97.5 kg • 214.95 lbs", eye_color: "Brown", hair_color: "Black", img_url: "https://res.cloudinary.com/djzhu5kfj/image/upload/v1633545122/Flatiron%20-%20Phase%204%20Project/Blade_lfrs4i.jpg", ani: "", superhero_id: blade.id)
app4 = Appearance.create(gender: "Female", species: "Tamaranean", height: "185.4 cm • 6\'1\"", weight: "95 kg • 209.44 lbs", eye_color: "Green", hair_color: "Red", img_url: "https://res.cloudinary.com/djzhu5kfj/image/upload/v1633545109/Flatiron%20-%20Phase%204%20Project/Starfire_ayopvt.jpg", ani: "", superhero_id: starfire.id)
app5 = Appearance.create(gender: "Female", species: "Half Human/Demon", height: "180.3 cm • 5\'11\"", weight: "63 kg • 138.89 lbs", eye_color: "Indigo", hair_color: "Black", img_url: "https://res.cloudinary.com/djzhu5kfj/image/upload/v1633545113/Flatiron%20-%20Phase%204%20Project/Raven_o1iutg.jpg", ani: "", superhero_id: raven.id)
app6 = Appearance.create(gender: "Male", species: "Vitrumite", height: "188 cm • 6\'2\"", weight: "113.4 kg • 250 lbs", eye_color: "Brown", hair_color: "Black", img_url: "https://res.cloudinary.com/djzhu5kfj/image/upload/v1633545115/Flatiron%20-%20Phase%204%20Project/Omni-Man_v0t3si.jpg", ani: "", superhero_id: omniman.id)
app7 = Appearance.create(gender: "Female", species: "Human", height: "172.7 cm • 5\'8\"", weight: "57 kg • 125 lbs", eye_color: "Green", hair_color: "Orange", img_url: "https://res.cloudinary.com/djzhu5kfj/image/upload/v1633545123/Flatiron%20-%20Phase%204%20Project/Atom_Eve_ui5hln.jpg", ani: "", superhero_id: atom_eve.id)
app8 = Appearance.create(gender: "Male", species: "Human", height: "220 cm • 7\'3\"", weight: "255 kg • 562 lbs", eye_color: "Blue", hair_color: "Blond", img_url: "https://res.cloudinary.com/djzhu5kfj/image/upload/v1633545125/Flatiron%20-%20Phase%204%20Project/Allmight_zglj9c.jpg", ani: "", superhero_id: all_might.id)
